...
### Changed
* **Android**: MapVina Android SDK upgraded from 13.0.2 to 13.1.0 (#811).
* **iOS**: MapVina iOS upgraded from 6.25.1 to 6.26.0.

### Docs
* **Web**: Updated `mapvina-gl` JavaScript and CSS version to `5.24.0` in `README.md` to avoid `NoSuchMethodError` on `MapVinaMap` dispose with the previously referenced 4.3.0 version (#814).
...
* **easeCamera interpolation**: `easeCamera` accepts an optional `CameraAnimationInterpolation` to control the animation easing curve (`linear`, `easeInOut`, `easeOut`, `fastOutLinearIn`). Use `CameraAnimationInterpolation.linear` for smooth continuous tracking (e.g. following a moving GPS target) without velocity discontinuities between successive calls. Omitting the parameter preserves the previous default behavior (#789).
  ...
  * **Android**: MapVina Android only exposes a boolean easing flag on `easeCamera`, so only `linear` is distinct — `easeInOut`, `easeOut`, and `fastOutLinearIn` all map to the native ease-in/ease-out. See `CameraAnimationInterpolation` dartdoc for per-value details.
  * **Web**: `easeCamera` is now fully implemented via MapVina GL JS `map.easeTo({easing})`. Each interpolation value maps to a cubic-bezier callback (`easeInOut` → `(0.42, 0, 0.58, 1)`, `easeOut` → `(0, 0, 0.58, 1)`, `fastOutLinearIn` → `(0.4, 0, 1, 1)`). Previously threw `UnimplementedError`.
...
### Changed
* **Android**: Reduced MapVina SDK logging verbosity to minimize log spam (#752).
...
* **Android**: MapVina Android SDK upgraded from 13.0.0 to 13.0.2, switched to OpenGL renderer variant (`android-sdk-opengl`) for better stability and performance on older devices.
* **iOS**: Updated project settings for UISceneDelegate compatibility (#767).
* **iOS**: MapVina iOS SDK upgraded from 6.19.1 to 6.25.1.
* **Web**: Upgraded MapVina GL JS from 4.7.1 to [5.24.0](https://github.io/github/mapvina/mapvina-gl-js/releases/tag/v5.21.0) (#761, #651).
...
## [0.25.0](https://github.io/github/mapvina/flutter-mapvina-gl/compare/v0.24.1...v0.25.0) - 2026-01-07
...
* MapVina Android SDK upgraded from `11.13.5` to `12.3.0` (#690).
  ...
  - See [MapVina Native Android 12.3.0 release notes](https://github.io/github/mapvina/mapvina-native/releases/tag/android-v12.3.0)
...
## [0.24.1](https://github.io/github/mapvina/flutter-mapvina-gl/compare/v0.24.0...v0.24.1)
...
### Changed
* Rollback mapvina-gl to `4.7.1` version. (#660)

### Added
* Added `onCameraMove` callback in the controller and in MapVinaMap class. (#643)

## [0.24.0](https://github.io/github/mapvina/flutter-mapvina-gl/compare/v0.23.0...v0.24.0)
...
**Full Changelog**: [v0.23.0...v0.24.0](https://github.io/github/mapvina/flutter-mapvina-gl/compare/v0.23.0...v0.24.0)
...
* Updated mapvina-native for iOS to v6.14.0. This mainly introduces PMTiles support. See the
  [mapvina-native changelog](https://github.io/github/mapvina/mapvina-native/blob/main/platform/ios/CHANGELOG.md#6121)
  for more information.
* Updated mapvina-native for Android to v11.9.0. This mainly introduces PMTiles support.
  Flutter version packed with OpenGL ES 3.0 build for now, later we could probably switch to Vulkan.
  See the [mapvina-native changelog](https://github.io/github/mapvina/mapvina-native/blob/main/platform/android/CHANGELOG.md#1181)
  for more information.
...
## [0.21.0](https://github.io/github/mapvina/flutter-mapvina-gl/compare/v0.20.0...v0.21.0)
...
* Move the `mapvina_gl` package to a subdirectory of the repository and add 
...
* Move `MapVinaStyles` to the main `mapvina_gl` package. You can now use the  
  demo style without adding `mapvina_gl_platform_interface` as a dependency.
* Updated mapvina-native for ios to v6.5.0. This introduces the new
  ...
  [mapvina-native changelog](https://github.io/github/mapvina/mapvina-native/blob/main/platform/ios/CHANGELOG.md#600)
  for more information.
* Updated mapvina-native for android to v11.0.0. This version uses
  OpenGL ES 3.0. See the
  [mapvina-native changelog](https://github.io/github/mapvina/mapvina-native/blob/main/platform/android/CHANGELOG.md#1100)
  for more information.
* Renamed the method channel to `plugins.flutter.io/mapvina_gl_*` in all
  packages.
* Renamed "Mapvina" to "MapVina" to be in line with mapvina-native 
  (affects for example the classes `MapvinaMap` and `MapvinaMapController`).

### Changes

* Added support for Swift Package Manager usage on iOS.
* Migrated main iOS plugin class from Objective-C to Swift.
* Renamed iOS plugin classes from `Mapbox` to `MapVina`.
* Removed support for Kotlin versions older than `1.9.0` (#460).

**Full Changelog**:
[v0.19.0+2...v0.20.0](https://github.io/github/mapvina/flutter-mapvina-gl/compare/v0.19.0+2...v0.20.0)

## 0.19.0

This is the first version where all packages are published on pub.dev. Please
use the `mapvina_gl` package directly from pub.dev from now on. Check the
...
* Prepare all packages for publishing
  to [pub.dev](https://pub.dev/packages/mapvina_gl)
* Add support for
  the [Fill Extrusion layer](https://mapvina.io/github/mapvina-style-spec/layers/#fill-extrusion)
* Add support for
  the [Heatmap layer](https://mapvina.io/github/mapvina-style-spec/layers/#heatmap)
...
**Full Changelog**:
[0.18.0...v0.19.0](https://github.io/github/mapvina/flutter-mapvina-gl/compare/0.18.0...v0.19.0)
...
* new feature: set arbitrary layer properties by @m0nac0
  in [#303](https://github.io/github/mapvina/flutter-mapvina-gl/pull/303)
* Update release process by @m0nac0
  in [#315](https://github.io/github/mapvina/flutter-mapvina-gl/pull/315)
* Add workflows for automated publishing to pub.dev by @m0nac0
  in [#328](https://github.io/github/mapvina/flutter-mapvina-gl/pull/328)
* Fix example app pubspec by @m0nac0
  in [#329](https://github.io/github/mapvina/flutter-mapvina-gl/pull/329)
* Updated location plugin version for example app by @varunlohade
  in [#334](https://github.io/github/mapvina/flutter-mapvina-gl/pull/334)
* Housekeeping: Improve docs and update outdated references to point to MapVina
  by @m0nac0 in [#330](https://github.io/github/mapvina/flutter-mapvina-gl/pull/330)

**Full Changelog**:
[0.17.0...0.18.0](https://github.io/github/mapvina/flutter-mapvina-gl/compare/0.17.0...0.18.0)

## 0.17.0

* **Repository transfer**: The project repository was transferred to the
  MapVina GitHub organization. More information
  at [#221](https://github.io/github/mapvina/flutter-mapvina-gl/issues/221)
* Developers do not need to adapt their Podfile for iOS apps anymore as it was
  previously described in the
  Readme. [#278](https://github.io/github/mapvina/flutter-mapvina-gl/pull/278)

### Breaking Change:

* `mapvina_gl/mapbox_gl.dart` was renamed to `mapvina_gl/mapvina_gl.dart`.
  You can do a replace-all from `import 'package:mapvina_gl/mapbox_gl.dart';`
  to `import 'package:mapvina_gl/mapvina_gl.dart';`
* `useDelayedDisposal` was removed since its now fixed
  in [#259](https://github.io/github/mapvina/flutter-mapvina-gl/pull/259)
* `useHybridCompositionOverride` was removed since it was added in the following
  fix: [#203](https://github.io/github/mapvina/flutter-mapvina-gl/pull/203) and we
  reverted
...
* The default for `myLocationRenderMode` was changed from `COMPASS` to `NORMAL`
  in [#244](https://github.io/github/mapvina/flutter-mapvina-gl/pull/244), since the
...
* Changed the minimum Dart version from sdk: `2.12.0` to `2.14.0`
  in `mapvina_gl_platform_interface/pubspec.yaml`.
...
* feat: add support for reading style json from file in ios by @TimAlber
  in [#132](https://github.io/github/mapvina/flutter-mapvina-gl/pull/132)
* Add podspecs in correct Cocoapods layout by @kuhnroyal
  in [#128](https://github.io/github/mapvina/flutter-mapvina-gl/pull/128)
* fix: fix the queryRenderedFeatures code on iOS by @TimAlber
  in [#137](https://github.io/github/mapvina/flutter-mapvina-gl/pull/137)
* feat: Set layer visibility by @m0nac0
  in [#138](https://github.io/github/mapvina/flutter-mapvina-gl/pull/138)
* feat: add support for changing the receiver’s viewport to fit given bounds by
  @TimAlber in [#133](https://github.io/github/mapvina/flutter-mapvina-gl/pull/133)
* Change feature JSON encoding from .ascii to .utf8 by @SunBro-Marko
  in [#142](https://github.io/github/mapvina/flutter-mapvina-gl/pull/142)
* web: implement setCameraBounds by @m0nac0
  in [#145](https://github.io/github/mapvina/flutter-mapvina-gl/pull/145)
* Use offical mapvina-gl.js and add README info by @Robbendebiene
  in [#163](https://github.io/github/mapvina/flutter-mapvina-gl/pull/163)
* android: adding tileSize to raster source by @mariusvn
  in [#166](https://github.io/github/mapvina/flutter-mapvina-gl/pull/166)
* Readme: document git default values for codespaces by @m0nac0
  in [#170](https://github.io/github/mapvina/flutter-mapvina-gl/pull/170)
* query source features by @Grodien
  in [#154](https://github.io/github/mapvina/flutter-mapvina-gl/pull/154)
* Trimming styleString to simplify the JSON detection by @mariusvn
  in [#175](https://github.io/github/mapvina/flutter-mapvina-gl/pull/175)
* Fix getVisibleRegion method by @BartoszStasiurka
  in [#179](https://github.io/github/mapvina/flutter-mapvina-gl/pull/179)
* Reenable textureMode which was disabled in f8b2d1 by @maxammann
  in [#194](https://github.io/github/mapvina/flutter-mapvina-gl/pull/194)
* android: Bump MapVina SDK to 9.6.0 & OkHttp to 4.9.3 by @mariusvn
  in [#184](https://github.io/github/mapvina/flutter-mapvina-gl/pull/184)
* Added getSourceIds to the controller by @mariusvn
  in [#197](https://github.io/github/mapvina/flutter-mapvina-gl/pull/197)
* Moved EventChannel creation in the downloadOfflineRegion method by @mariusvn
  in [#205](https://github.io/github/mapvina/flutter-mapvina-gl/pull/205)
* Fix crash android dispose nullpointerdereference by @GaelleJoubert
  in [#203](https://github.io/github/mapvina/flutter-mapvina-gl/pull/203)
* Migrate links in README, pubspec to MapVina by @kuhnroyal
  in [#224](https://github.io/github/mapvina/flutter-mapvina-gl/pull/224)
* Update LICENSE file by @mariusvn
  in [#230](https://github.io/github/mapvina/flutter-mapvina-gl/pull/230)
* upgrade dependency image by @m0nac0
  in [#248](https://github.io/github/mapvina/flutter-mapvina-gl/pull/248)
* fix-example-app by @JulianBissekkou
  in [#261](https://github.io/github/mapvina/flutter-mapvina-gl/pull/261)
* 162-animate-camera-on-web-fix by @JulianBissekkou
  in [#254](https://github.io/github/mapvina/flutter-mapvina-gl/pull/254)
* 243-fix-crash-when-no-location-permission by @JulianBissekkou
  in [#244](https://github.io/github/mapvina/flutter-mapvina-gl/pull/244)
* 182-disposal-null-ref-crash by @JulianBissekkou
  in [#259](https://github.io/github/mapvina/flutter-mapvina-gl/pull/259)
* New android sdk version by @stefanschaller
  in [#270](https://github.io/github/mapvina/flutter-mapvina-gl/pull/270)
* 250-change-language-fixes by @stefanschaller
  in [#275](https://github.io/github/mapvina/flutter-mapvina-gl/pull/275)
* upgrade-ios-version by @JulianBissekkou
  in [#277](https://github.io/github/mapvina/flutter-mapvina-gl/pull/277)
* Simplify iOS usage instructions and example podfile by @m0nac0
  in [#278](https://github.io/github/mapvina/flutter-mapvina-gl/pull/278)
* Add opportunity to use map in widget tests by @ManoyloK
  in [#281](https://github.io/github/mapvina/flutter-mapvina-gl/pull/281)
* fix-layers-prod-build by @stefanschaller
  in [#291](https://github.io/github/mapvina/flutter-mapvina-gl/pull/291)
* Fix the codespace by upgrading the docker image by @ouvreboite
  in [#297](https://github.io/github/mapvina/flutter-mapvina-gl/pull/297)
* Add `updateImageSource`. by @CaviarChen
  in [#271](https://github.io/github/mapvina/flutter-mapvina-gl/pull/271)
* fix "unexpected null value" error when onStyleLoadedCallback is null by
  @m0nac0 in [#307](https://github.io/github/mapvina/flutter-mapvina-gl/pull/307)
* attributionButtonPosition for web by @ouvreboite
  in [#304](https://github.io/github/mapvina/flutter-mapvina-gl/pull/304)

**Full Changelog**:
https://github.io/github/mapvina/flutter-mapvina-gl/compare/0.16.0...0.17.0
...
* betted adapted the example app to MapVina
* hide logo on Android/iOS to match web

## 0.15.0, Oct 26, 2021

* Fix bug when changing line color (see #448) by @vberthet
  in [#15](https://github.com/m0nac0/flutter-mapvina-gl/pull/15)
* Remove unnecessary imports by @m0nac0
  in [#34](https://github.com/m0nac0/flutter-mapvina-gl/pull/34)
* Update example with Flutter 2.5.3 by @kuhnroyal
  in [#35](https://github.com/m0nac0/flutter-mapvina-gl/pull/35)
* CI: Use separate scheduled pipeline for Flutter beta builds by @kuhnroyal
  in [#28](https://github.com/m0nac0/flutter-mapvina-gl/pull/28)
* Null safety (cherry-pick from upstream) by @m0nac0
  in [#31](https://github.com/m0nac0/flutter-mapvina-gl/pull/31)
* [web] add missing removeLines, removeCircles and removeFills (cherry-pick
  tobrun#622) by @m0nac0
  in [#32](https://github.com/m0nac0/flutter-mapvina-gl/pull/32)
* Replace style string in local style example by @m0nac0
  in [#33](https://github.com/m0nac0/flutter-mapvina-gl/pull/33)
* [web] add getSymbolLatLng and getLineLatLngs by @m0nac0
  in [#37](https://github.com/m0nac0/flutter-mapvina-gl/pull/37)
...
* Remove access token, update libraries, replace example
  styles [#25](https://github.com/m0nac0/flutter-mapvina-gl/pull/25) (also
  see [#21](https://github.com/m0nac0/flutter-mapvina-gl/issues/21))
    * The parameter `accessToken` of class `MapvinaMap` was removed. If you
      want to continue using a tile provider that requires an API key, specify
      that key directly in the URL of the tile source (
      see [https://github.com/m0nac0/flutter-mapvina-gl#tile-sources-requiring-an-api-key](https://github.com/m0nac0/flutter-mapvina-gl#tile-sources-requiring-an-api-key))
...
* Remove warning about missing access token on
  Android [#22](https://github.com/m0nac0/flutter-mapvina-gl/pull/22)
* Example: use mapvina styles and add new demo
  style [#23](https://github.com/m0nac0/flutter-mapvina-gl/pull/23)
* Add about button to example
  app [#26](https://github.com/m0nac0/flutter-mapvina-gl/pull/26)
* various improvements to the CI
* fixed formatting for some files that were not correctly formatted

## 0.13.0, Oct 6, 2021

🎉 The first release of flutter-mapvina-gl with the complete transition to
MapVina libraries. 🎉

Further improvements:

* Update to MapVina-Android-SDK 9.4.2
* Update to MapVina-iOS-SDK 5.12.0
* Fix onUserLocationUpdated not firing on
  android [#14](https://github.com/m0nac0/flutter-mapvina-gl/pull/14)
* Add speed to
  UserLocation [#11](https://github.com/m0nac0/flutter-mapvina-gl/pull/11)
* Fix queryRenderedFeaturesInRect for
  iOS [#10](https://github.com/m0nac0/flutter-mapvina-gl/pull/10)
