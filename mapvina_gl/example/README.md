...
* Loading a public style (`https://maps.mapvina.com/styles/v2/streets.json?key=public_key`)
...
See the full [example app](https://github.io/github/mapvina/flutter-mapvina-gl/tree/main/mapvina_gl_example)!
...
class _ExampleHomePageState extends State<_ExampleHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: MapVinaMap(
        styleString: 'https://maps.mapvina.com/styles/v2/streets.json?key=public_key',
